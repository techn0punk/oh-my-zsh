...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/techn0punk/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/techn0punk/oh-my-zsh/master/tools/install.sh -O -)"
```
...
We'll admit it. Early in the Oh My Zsh world, we may have gotten a bit too theme happy. We have over one hundred themes now bundled. Most of them have [screenshots](https://wiki.github.com/techn0punk/oh-my-zsh/themes) on the wiki. Check them out!
...
```shell
export ZSH="$HOME/.dotfiles/oh-my-zsh"; sh -c "$(curl -fsSL https://raw.githubusercontent.com/techn0punk/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
git clone https://github.com/techn0punk/oh-my-zsh.git ~/.oh-my-zsh
```
...
We also need people to test out pull-requests. So take a look through [the open issues](https://github.com/techn0punk/oh-my-zsh/issues) and help where you can.
